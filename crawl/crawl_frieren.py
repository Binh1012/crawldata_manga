...
BASE_URL = "https://frieren-manga.com/manga/sousou-no-frieren-chapter-{}/"
...
HEADERS = {
    ...
    "Referer": "https://frieren-manga.com/"
}
...
def get_images(soup):
    ...
    for img in soup.select("div.reading-content img.wp-manga-chapter-img"):
